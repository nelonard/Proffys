...
const {subjects, dates, getSubject, convertHoursToMinutes } = require('./utils/format')
...
function pageGiveClasses(req,res){
    return res.render("give-classes.html",{subjects, dates})
}
